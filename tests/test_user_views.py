...
os.environ['DATABASE_URL'] = "postgresql:///simply_art-test"
...
class MessageViewTestCase(TestCase):
    ...
    def setup_likes(self):
        m1 = Message(text="trending art", user_id=self.testuser_id)
        m2 = Message(text="Eating some lunch", user_id=self.testuser_id)
        m3 = Message(id=9876, text="likable art", user_id=self.u1_id)
    ...
    def test_remove_like(self):
        ...
        m = Message.query.filter(Message.text == "likable art").one()
        ...
        # Now we are sure that testuser likes the message "likable art"
